...
app.whenReady().then(async () => {
  ...
  target = new BrowserWindow({x:430,y:30,width:580,height:680,show:false,titleBarStyle:'hiddenInset',
  ...
  target.showInactive();
  if (mode === 'electron') {
    source = new BrowserWindow({x:0,y:30,width:400,height:680,show:false,titleBarStyle:'hiddenInset',webPreferences:{nodeIntegration:false,contextIsolation:true,webSecurity:true}});
